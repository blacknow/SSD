...
parser.add_argument('--dataset', default='CORE_CORELESS', choices=['VOC', 'COCO','CORE_CORELESS'],
                    type=str, help='VOC or COCO OR CORE_CORELESS')
...
def train():
    ...
    elif args.dataset == 'CORE_CORELESS':
        if args.dataset_root == COCO_ROOT:
            parser.error('Must specify dataset if specifying dataset_root')
    '''
    cfg = core_coreless
