...
parser.add_argument('--predicted_file', default='D:/2019_fall_semester/01_MachineLearning/ssd/eval1epoch_500/results', type=str, help='Checkpoint state_dict file for transfer learning')
...
annopath = os.path.join(SIXray_ROOT, 'Anno_test', '%s.xml')#测试集标注文件路径
test_imagesetfile = "D:/2019_fall_semester/01_MachineLearning/ssd/data/VOC_0712/VOCdevkit/core_coreless_test/core_coreless_test.txt"#测试集里面的图片名
'''
